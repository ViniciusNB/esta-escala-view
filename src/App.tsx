...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center text-center px-4 overflow-hidden">
      ...
      <div className={`${isDesktop ? "" : "relative"} p-4 mb-15 max-w-5xl mx-auto`}>
        <div className="text-center justify-center relative align-middle top-2">
